...
using OnlineBookStore.Admin;

namespace OnlineBookStore
{
    public partial class Motivational_Page : Form
    {
        DataTable dt = ImpValues.getBookInfo("Motivational");
        public Motivational_Page()
        {
            InitializeComponent();
        }
        ...
        private void Motivational_Page_Load(object sender, EventArgs e)
        {
            //int count = ImpValues.getTotalBooks("Motivational");
